...
| `69ff34b4-0000-2b2b-a390-14c14ef7af10` | `sq_marts_sales_overview` | `msklad-bi-prod.marts.sales_overview` | **`every 2 hours`** (явное расписание в конфиге; nextRunTime 2026-07-27T15:34:00Z) | SUCCEEDED · провенанс: `/reference/sq_cadence_2026-07-27.md §4` |
...
`nextRunTime` — `/reference/sq_cadence_2026-07-27.md §4`, замер 2026-07-27T15:13Z.
