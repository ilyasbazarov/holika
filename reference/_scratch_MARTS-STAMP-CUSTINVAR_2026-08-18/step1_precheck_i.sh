...
wc -c "${OUT_DIR}/live_query_extracted_2026-08-18.sql" reference/sql/sq_marts_customer_invoices_ar.sql

echo "=== diff (живой снимок vs снимок репо) ==="
diff "${OUT_DIR}/live_query_extracted_2026-08-18.sql" reference/sql/sq_marts_customer_invoices_ar.sql
echo "diff rc=$?"
