...
RUN_NAME="projects/420804682491/locations/asia-east1/transferConfigs/6a22a243-0000-20fd-a458-883d24f4cad4/runs/6a8438c1-0000-2641-becf-14c14ef75dd4"
...
if [ "${STATE}" = "FAILED" ]; then
  echo "=== errorStatus ==="
  python3 -c "import json; d=json.load(open('${OUT_DIR}/run_final_2026-08-18.json')); print(d.get('errorStatus'))"
fi
