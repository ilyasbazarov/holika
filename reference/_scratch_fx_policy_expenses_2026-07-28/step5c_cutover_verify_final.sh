...
echo
echo "### (1) Автоматический прогон sq_marts_expenses сегодня, 2026-07-28, слот ~11:10 UTC ###"
bq query --use_legacy_sql=false --format=prettyjson \
"SELECT
  job_id, creation_time, end_time, state, error_result, user_email
...
echo
echo "### (1б) Контроль инструмента: всего заданий с целью marts.expenses с 2026-07-13 (было 16 на прошлом замере, ожидание 17) ###"
bq query --use_legacy_sql=false --format=prettyjson \
