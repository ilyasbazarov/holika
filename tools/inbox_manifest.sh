...
while IFS= read -r f; do
  ...
  ' "$f")
  # Пункт [сейчас], адресованный файлу ВНЕ полномочий сборки (_ASSEMBLER.md §1: четыре файла).
